(function() {
  ...
  _.last = function(array, n) {
    // to account for index larger than length.
    if (n > array.length) {
      return array;
    }
  ...
  _.reject = function(collection, test) {
    ...
    var results = _.filter(collection, function (value) {
      return !(test(value));
    });
  ...
  _.uniq = function(array) {
    ...
    _.each(array, function (value) {
      var found = _.indexOf(results, value);
  ...
  _.every = function(collection, iterator) {
    ...
    return _.reduce(collection, function(allTrue, item) {
      ...
      return Boolean(truthTest(item)) && allTrue;
    }, true);
  };
  ...
  _.some = function(collection, iterator) {
    ...
    return _.reduce(collection, function(someTrue, item) {
      ...
      return Boolean(truthTest(item)) || someTrue;
    }, false);
  };
